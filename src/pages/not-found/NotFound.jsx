  ...
  return (
    <div className='h-screen w-full flex justify-center items-center flex-col gap-[2rem]'>
      ...
      <div className="flex gap-[2rem]">
        <button onClick={() => navigate("/")} className="p-[10px] text-white bg-[#B88E2F] rounded-[24px]">Go Home</button>
        <button onClick={() => navigate(-1)} className="p-[10px] text-white bg-[#B88E2F] rounded-[24px]">Go back</button>
      </div>
    </div>
  )
}
